...
client.on(`ready`, function () {
    console.log("DogBot est connecte");
    client.user.setActivity("D.aide")
})
...
client.on("message", message => {
    if (message.content === prefix + "aide")
        var aide_embed = new Discord.RichEmbed()
            ...
            .addField("D.aide", "Vous affiche le Menu d'aide")
            .addField("D.invite", "Vous affiche une invitation")
            .addField("D.stat", "Vousaffiche quelques Information sur Vous")
            .addField("D.infobot", "Vous affiche des Information sur le bot")
            .addField("D.infoserv", "Vous affiche quelque Information sur le Serveur")
            .addField("D.kick", "KIck une personne choisi")
            .addField("D.ban", "Ban la personne demander")
            .addField("D.clear", "efface le nombres de message demander")
    ...
    if (message.content === prefix + "invite")
        var invite_embed = new Discord.RichEmbed()
            ...
            .setFooter("DogSter'Bot| By Nefer#4398")
